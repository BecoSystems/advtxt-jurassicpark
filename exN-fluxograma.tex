...
\begin{tikzpicture}
    ...
    \node (sim) [print, below of=dec1, node distance=4cm] {Você pega o chiclete, masca e assopra até formar uma bola gigante que te faz flutuar.};
    \node (nao) [print, right of=dec1, node distance=2cm] {Você decide pegar a bazuca e atirar no t-rex, porém a bazuca falha e explode em você. Este é seu fim meu amigo.};
